...
import jacob_pb2 as jacob__pb2
...
def add_GreeterServicer_to_server(servicer, server):
    ...
    generic_handler = grpc.method_handlers_generic_handler(
            'jacob.Greeter', rpc_method_handlers)
...
class Greeter(object):
    ...
    def SayHello(request,
            ...
            timeout=None,
            metadata=None):
        return grpc.experimental.unary_unary(request, target, '/jacob.Greeter/SayHello',
